              ...
              <div className="flex justify-between h-16">
                <div className="flex">
                  <div className="flex-shrink-0 flex items-center">
                    ...
                    <span className="font-medium text-black px-3 py-2 rounded-md text-sm">  <Link className="font-medium text-gray-500 hover:text-gray-900 px-3 py-2 rounded-md text-sm" href={"/"}>
                    VISION FX
                  </Link></span>
                  </div>
                </div>
                <div className="flex items-center">
                  <div className="hidden md:block">
                    <Link className="font-medium text-gray-500 hover:text-gray-900 px-3 py-2 rounded-md text-sm" href={"/dashboard"}>
                      Mesimet me Pagese
                    </Link>
                  </div>
                </div>
